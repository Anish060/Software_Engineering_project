...
const Login = () => {
  ...
  return (
    ...
    <div className="flex flex-col gap-2 items-center px-10 py-14">
      <div className="text-3xl text-center text-black font-bold tracking-wide">
        Legal Ease
      </div>
      <form className="flex flex-col gap-6 p-6 bg-white rounded-lg border shadow-lg min-w-80">
